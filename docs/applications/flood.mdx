...
You will need to use the WebUI port obtained from Settings > Web UI > Port, then set the URL to `127.0.0.1:PORT` replacing PORT with your port number from the settings.
